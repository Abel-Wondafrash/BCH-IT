...
class ProductCategory(models.Model):
    ...
    property_account_wip_id = fields.Many2one('account.account', company_dependent=True,
        string="Work in progress Account", oldname="property_account_wip",
        domain=[('deprecated', '=', False)],
        help="This account will be used for manufacturing order.")

    property_account_moa_id = fields.Many2one('account.account', company_dependent=True,
        string="Overage Account", oldname="property_account_moh",
        domain=[('deprecated', '=', False)],
       help="This account will be used for manufacturing order.")
    property_account_la_id = fields.Many2one('account.account', company_dependent=True,
        string="Labour Account", oldname="property_account_la",
        domain=[('deprecated', '=', False)],
        help="This account will be used for manufacturing order.")
#----------------------------------------------------------
# Products
