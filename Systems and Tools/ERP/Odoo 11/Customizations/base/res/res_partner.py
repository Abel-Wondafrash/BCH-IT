...
class Partner(models.Model):
    ...
    partner_code = fields.Char(string="partener code")
    inital_balance = fields.Float("Initial Balance")
    ...
    current_balance_display = fields.Float( string="Current Balance Display")
    ...
    def create(self, vals):
        ...
        # _logger.info('-------!!!!!!!!Start partner- =%s',partner.code)
        # if partner.customer:
        #     name='CUS-00'
        #     partner.write({"code": str(name+self.id)})
        partner._fields_sync(vals)
