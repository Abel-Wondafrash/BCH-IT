void pressFind () {
  String ahkPath = "C:\\Users\\Abel Wondafrash\\AppData\\Local\\Programs\\AutoHotkey\\v2\\AutoHotkey64.exe";
  String scriptPath = dataPath("scripts/click_find.ahk");
  String button = winContainsText (WIN_VBB, "LOOKUP")? "BITMAPBUTTON4" : "BITMAPBUTTON3";
