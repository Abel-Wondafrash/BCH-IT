...

{
    ...
    'depends': ['stock_account','hr','account'],
    'data': [
        ...
        'report/actual_costing.xml',
        'report/actual_costing.xml',
        'report/purchase_request.xml',
        'report/purchase_reports.xml',
        'report/purchase_order_report.xml',
        'report/forign_purchase_request.xml',
        # 'report/forign_purchase_order_report.xml',
        
        
        'report/forign_purchase_reports.xml',
        'views/purchase_views.xml',
        'views/forign_purchase_view.xml',
        ...
        'report/forign_purchase_order_templates.xml',
        'report/purchase_quotation_templates.xml',
        'report/forign_purchase_quotation_templates.xml',
    ],
    'test': [
